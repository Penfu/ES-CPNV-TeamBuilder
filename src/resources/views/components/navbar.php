        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <?php if ($Auth::check()) : ?>
                ...
                <div class="ml-3 relative">
                    ...
                    <div id="profile-dropdown" class="hidden origin-top-right absolute right-0 mt-1 w-48 rounded-md shadow-lg py-2 bg-white dark:bg-dark-700 ring-1 ring-black ring-opacity-5 focus:outline-none divide-y divide-gray-100 dark:divide-dark-600 animate-show" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        <div class="py-1" role="none">
                            <span class="block px-4 py-2 text-sm text-gray-700 dark:text-white" role="menuitem" tabindex="-1" id="user-menu-item-0"><?= $Auth::user()->name ?></span>
                        </div>
                        <div class="py-1" role="none">
                            <form action="/logout" method="POST">
                                <button type="submit" class="block px-4 py-2 text-sm text-gray-700 dark:text-dark-100" role="menuitem" tabindex="-1" id="user-menu-item-2">Se déconnecter</button>
                            </form>
                        </div>
                    </div>
                </div>
