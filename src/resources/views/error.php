        ...
        <div class="w-8/12 min-h-screen m-auto flex items-center justify-center">
            <div class="py-16 md:py-32 w-full bg-white dark:bg-dark-900 shadow overflow-hidden sm:rounded-lg">
                <div class=" pt-8 text-center text-gray-900 dark:text-dark-100">
                    <h2 class="text-9xl font-bold text-purple-400"><?= $code ?></h2>
                    <h2 class="text-2xl font-medium py-8"><?= $message ?></h2>
                    <a href="<?= $router::route('home') ?>" class="px-6 py-3 bg-gradient-to-r uppercase from-purple-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 text-white font-semibold rounded-md">
